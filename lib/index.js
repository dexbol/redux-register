...
function enhanceStore(store) {
  store.register = function () {
    registerReducerByMap.apply(void 0, arguments);
...
export { reducerShape, makeFinalStateByReducerShape, rootReducer, registerReducer, checkTypeNamespace, registerReducerByMap, Register };
